...
public class project_3 {
	public static void main(String[]args) {
		...
		System.out.print("Enter full path of image to be grayscaled and inverted (jpg, gif, or png): ");
		...
		for(Pixel p: image) { // Loop through each pixel in the image
			...
			double average = 255 - ((red * 0.299) + (green * 0.587) + (blue * 0.114)); // Get 255 minus the average rgb amount
			if(average < 25.5) {
				p.setRed(color0);
