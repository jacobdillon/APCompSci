...
public class Student {
	...
	public String validateData() {
		...
		else if (test1 < 0 || test1 > 100) return "ERROR: must have 0 <= test score 1 <= 100";
		else if (test2 < 0 || test2 > 100) return "ERROR: must have 0 <= test score 2 <= 100";
		else if (test3 < 0 || test3 > 100) return "ERROR: must have 0 <= test score 3 <= 100";
		else return null;
	}
